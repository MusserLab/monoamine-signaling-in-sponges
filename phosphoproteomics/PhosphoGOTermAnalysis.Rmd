...
- `phosphoproteomics/data/sl_go_merged_id.tsv` — Gene-to-GO term mapping (PROST-based annotations)
...
go_map <- read.delim(here("phosphoproteomics", "data", "sl_go_merged_id.tsv"),
