...
# NOTE: gene_lengths$gene_names is not extracted from rownames here (unlike the
# phospho GO script). This means all genes receive the median length in the
# match below, effectively running goseq WITHOUT length-bias correction.
# This is intentional — see PhosphoGOTermAnalysis.Rmd for the length-corrected version.
