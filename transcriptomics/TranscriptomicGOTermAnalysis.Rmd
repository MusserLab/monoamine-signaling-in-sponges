...
- `transcriptomics/data/2020_08_13_merged_trinity_gene_gene_ontology_assignments_jake_manual_additions2_forsl2_final2.txt` — Gene-to-GO term mapping (eggNOG mapper + manual corrections from Musser et al. 2021)
...
go_map <- read.delim(here("transcriptomics", "data", "2020_08_13_merged_trinity_gene_gene_ontology_assignments_jake_manual_additions2_forsl2_final2.txt"), header = TRUE, stringsAsFactors = FALSE)[, 1:2]
